...
LABEL org.opencontainers.image.title="Hello Kubernetes!" \
      ...
      org.opencontainers.image.url="https://hub.docker.com/r/santhosh256/hello-kubernetes/" \
      org.opencontainers.image.documentation="https://github.com/santhosh256/hello-kubernetes/README.md" \
      org.opencontainers.image.vendor="Paul Bouwer" \
      org.opencontainers.image.licenses="MIT" \
      org.opencontainers.image.source="https://github.com/santhosh256/hello-kubernetes.git" \
